    ...
    <main>
        <section class="sidebar">
            <aside>
                   ...
                   <?php
                          $menus = new FilesystemIterator("view/template"); 
                          $PageName = $_REQUEST['page']??'';
                          $templates = new templates($PageName);
                     ...
                     ?>
                           ...
                           <li class="nav-item">
                                <a class="nav-link <?php if($name === $PageName) echo 'active'; ?>" aria-current="page" href="<?php echo ABSPATH.'dashboad/page?page='.$name; ?>">
        ...
        <section class="body float-right w-85 d-flex mt-12">
            ...
            <?php if(isset($PageName) && file_exists("view/template/{$PageName}.php")): ?>
            <form method="post" id="componentsave">
               ...
               <input type="submit" name="saveContent" class="dash-btn button-background mt-6 align-items-center d-block mx-auto w-25 round-button" value="Save">
                ...
                <?php  if(file_exists("view/template/{$PageName}.php")) include_once "view/template/{$PageName}.php"; ?>
               </div>
               </component>
        ...
        <form method="post" id="createComponent">
                   <div class="input-group">
                      ...
                      <div id="popup" class="pop-up-design rounded">
                          <div>
                          <div id="errs"> </div>
                          <input type="text" name="templatename" placeholder="Create a template" class="d-block form-control outline-none no-border mt-3 mb-6" onkeydown="if(event.key === 'Enter'){event.preventDefault();createPage();}">
                            <select name="type">
                          ...
                          <button class="dash-btn bg-white p-2 mr-1" onclick="createPage(); return false;">   Save</button>
