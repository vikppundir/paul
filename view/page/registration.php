		...
		<div class="row h-100 d-flex justify-content-center align-items-center">
			...
			<div class="col-md-5 mx-auto" id="register_from" style="<?php if(isset($_SESSION['otpEmail'])) echo 'display:none'; ?>">
				<div class="form-outer bg-white pt-3 pb-4 pr-2 pl-2 rounded">
					...
					<div class="btn button-background mt-6 align-items-center d-block mx-auto w-100 round-button register" onclick="register();">Register</div>
				</div>
				</form>
                </div>
					...
					<div class="form-inner">
                      <form method="post" id="verifyOtpForm">
						  ...
						  <div class="input-group">
                           ...
                           <div class="btn button-background mt-6 align-items-center d-block mx-auto w-100 round-button register" onclick="verifyOtp();">Verify</div>
