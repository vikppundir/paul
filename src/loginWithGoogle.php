   ...
   function login()
    {
        ...
        function button($buttonTest){
          return "<a class='btn button-background mt-6 align-items-center d-block mx-auto w-100 round-button' href='" . $this->createAuthUrl() . "'>{$buttonTest}</a>";
    }
}
